package com.kotlinJwt.demo.controller
...
import com.kotlinJwt.demo.service.HashService
import com.kotlinJwt.demo.service.TokenService
import com.kotlinJwt.demo.service.UserService
...
class AuthController(
    ...
    fun register(@RequestBody payload: RegisterDto): LoginResponseDto {
        ...
        val user = com.kotlinJwt.demo.model.User(
            name = payload.name,
